<?php
//Ketikkan Source Code 1 provinsi_form.php disini 
include ('inc/config.php');
$aksi = null;
if(isset($_GET['id'])) {
	$aksi = "Edit";
	$id = $_GET['id'];
	//baris dibawah ini disesuaikan dengan nama tabel dan id
...
//Batas Akhir Pengetikkan Source Code 1 provinsi_form.php
?>
...
<form  class="form-horizontal" method="POST" id="form1"  
	...
	<div class="controls">
		...
		value='<?php echo $data->nama?>' class='required'>
	</div>
	</div>
	...
	<div class="controls">
		...
		value='<?php echo $data->lat?>' class='required '>
	</div>
	</div>
	<div class="control-group">
	...
	<div class="controls">
		...
		<a href="index.php?mod=provinsi&pg=provinsi_view" class="btn btn-success">Batal</a>
	</div>
	</div>
</form>
<script type="text/javascript">
//Ketikkan Source Code 2 provinsi_form.php disini
...
//Batas Akhir Pengetikkan Source Code 2 provinsi_form.php	
</script>
</div>