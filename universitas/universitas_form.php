<!-- Ketikkan Source Code 1 universitas_form.php disini -->
<?php
...
if(isset($_GET['id'])) {
	...
	$sql = "select * from universitas where iduniversitas='$id'";
...
<div class='span4'>
	<h2 style="margin-left: 30px"> Form Universitas </h2>
	<form class="form-horizontal" method="POST" id="form1" enctype="multipart/form-data" action="universitas/universitas_action.php">
		<?php $id=$_GET['id'];?>
		<input type='hidden' name='id' value="<?php echo $id?>">

	<div class="control-group">
		<label class="control-label" for="nama">Nama Universitas</label>
		<div class="controls">
	...
	<div class="control-group">
		<div class="controls">
			...
			<a href="index.php?mod=universitas&pg=universitas_view" class="btn btn-success">Batal</a>
		</div>
	</div>
	</form>
...
<!-- Batas Akhir Pengetikan Source Code 1 universitas_form.php disini -->